...
angular.module('forms').controller('ResubmitFormController', ['$http', '$scope', '$rootScope', 'localStorageService', 'uiGridConstants', 'moment', 'myForm',
  function($http, $scope, $rootScope, localStorageService, uiGridConstants, moment, myForm) {
